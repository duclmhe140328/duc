                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                    <ul class="navbar-nav m-auto">
                        <c:if test="${account==null}">
                            <li class="nav-item">
                            <a class="nav-link" href="Login.jsp">Login as Customer</a>
                        </li>
                        </c:if>
                        <c:if test="${account!=null}">
                        <li class="nav-item">
                        ...
                        <c:if test="${account!=null}">
                        <li class="nav-item">
                            <a class="nav-link text-success" href="Login.jsp">Welcome ${account.userName}</a>
                        ...
                        <c:if test="${account!=null}">
                            <li class="nav-item">
                                <a class="nav-link text-success" href="Login.jsp">RollNumber: ${acc.cid}</a>
                            </li>
                        </c:if>
                          <c:if test="${account!=null}">
                            <li class="nav-item">
                               <a class="nav-link text-success" href="Login.jsp">Full Name: ${acc.fullName}</a>
                            </li>
                        </c:if> 
                        <c:if test="${account==null}">
                       <li class="nav-item">
